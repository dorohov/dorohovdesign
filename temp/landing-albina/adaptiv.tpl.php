	...
	<div class="container <?=$_prefix;?>container <?=$_prefix_page;?>container">	
		...
		<div class="<?=$_prefix;?>preview-block">
			<div class="<?=$_prefix;?>preview  is--imac">
				<img src="<?=$this->path('img');?>/lp-polki/bg-imac.png" alt="">
			</div>
			<div class="<?=$_prefix;?>preview  is--hands">
				<img src="<?=$this->path('img');?>/lp-polki/bg-hands.png" alt="">
			</div>
			<div class="<?=$_prefix;?>preview  is--flover">
				<img src="<?=$this->path('img');?>/lp-polki/bg-flover.png" alt="">
			</div>
		</div> 
	</div>
</div>