...
?>
<div class="<?=$_prefix;?>block" style="background-image: url('<?=$this->path('img');?>/lp-polki/bg-interface.jpg');">
			...
			<div class="iphone-slider__bg">
				<div class="iphone-slider__container">
					<div class="iphone-slider__item" 
						style="background-image:url(<?=$this->path('img');?>/lp-polki/slider-xs-item1.jpg)"
						data-style="background-image:url(<?=$this->path('img');?>/lp-polki/slider-xl-item3.jpg)"
					></div>
					<div class="iphone-slider__item" 
						style="background-image:url(<?=$this->path('img');?>/lp-polki/slider-xs-item2.jpg)"
						data-style="background-image:url(<?=$this->path('img');?>/lp-polki/slider-xl-item1.jpg)"
					></div>
					<div class="iphone-slider__item" 
						style="background-image:url(<?=$this->path('img');?>/lp-polki/slider-xs-item3.jpg)"
						data-style="background-image:url(<?=$this->path('img');?>/lp-polki/slider-xl-item2.jpg)"
					></div>
				</div>
			</div>
