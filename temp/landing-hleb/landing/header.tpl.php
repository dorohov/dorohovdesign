...
if(is_single() && get_field('post_add_type', get_post()->ID) == 'landing'){
	?>
	<link href="<? echo $this->path('css');?>/lp-hlebzavod.css" rel="stylesheet"> 
<?}?>
<?} else {?>
<?
if(is_single() && get_field('post_add_type', get_post()->ID) == 'landing'){
...
if(is_single() && get_field('post_add_type', get_post()->ID) == 'landing-inleco'){
	?>
	<link href="<? echo $this->path('css');?>/lp-inleco.css" rel="stylesheet">
	<?
}
if(is_single() && get_field('post_add_type', get_post()->ID) == 'landing-manikur'){
	?>
	<link href="<? echo $this->path('css');?>/lp-manikur.css" rel="stylesheet">
	<?
}
if(is_single() && get_field('post_add_type', get_post()->ID) == 'landing-orelstroy'){
	?>
	<link href="<? echo $this->path('css');?>/lp-orelstroy.css" rel="stylesheet">
	<?
}
if(is_single() && get_field('post_add_type', get_post()->ID) == 'landing-dixion'){
	?>
	<link href="<? echo $this->path('css');?>/lp-dixion.css" rel="stylesheet">
	<?
}
...
if(
	is_single() && get_field('post_add_type', get_post()->ID) == 'case-photo-jk'
	...
	?>
	<link href="<? echo $this->path('css');?>/case.css" rel="stylesheet">
	<?
}
