$(function() {		
	...
	$('.iphone-slider').each(function(index){
		...
		dots.on('click', '.iphone-slider__dot .iphone-slider__item-btn', null, function(event){
		...
		dots.find('.iphone-slider__dot').eq(0).find('.iphone-slider__item-btn').trigger('click');
